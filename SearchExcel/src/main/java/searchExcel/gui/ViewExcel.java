...
//		ViewExcel.showStatus = showStatus;
//		System.out.println("showStatus === " + showStatus + " ViewExcel.showStatus ===  "  + ViewExcel.showStatus);
//		lblStatus.setVisible(showStatus);
//	}
	...
	public void getStReport() {		
		txtSubmitResult.setText("\n" + this.currentTime + "\n" + this.stReport + "\n" + this.currentTime);
		frameMain.setTitle("search in excel...");
	}
	...
	public ViewExcel() 
	{
		...
		frameMain = new JFrame(" search in excel...");
		...
		lblFileName1.setBounds(10, 66, 25, 22);
...
//		txtFileName1.setHorizontalAlignment(0);
		...
		lblFileName2.setBounds(10, 104, 25, 22);
		...
		lblSubmit.setBounds(10, 456, 25, 22);
		...
		frameMain.setLocation(100, 100); //x,y
		...
		btnSubmit.addActionListener(new ActionListener( )
		{
			public void actionPerformed(ActionEvent ev)
			{
				System.out.println("lblStatus.setVisible(true)");
			}
		});
