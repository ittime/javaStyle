...
public class LdapPrimary {
	...
	public LdapPrimary() 
	{
        ...
        final String ldapUsername = "User-Name";
        final String ldapPassword = "Password";
        
        final String ldapAccountToLookup = "kesslery@domain";
     ...
     //   LdapPrimary ldap = new LdapPrimary();
        
        //1) lookup the ldap account
        SearchResult srLdapUser = null;
		try {
			srLdapUser = findAccountByAccountName(ctx, ldapSearchBase, ldapAccountToLookup);
		} catch (NamingException e) {
			// TODO Auto-generated catch block
