...
public class LogInLog {
		...
		public void LogIt(String msg_type, String subject, String description) 
		{
			Date     dNow        =   new Date( );
			String   StLogData   =   null;
			String   StLogFileName = "./login.log";
			int 	 os	= 0 ;
			String   StLogFileName1 = ".\\login.log";
			...
			if ( (!msg_type.equalsIgnoreCase("data")) &&  (!msg_type.equalsIgnoreCase("event")))
			{
				try
				{
					BufferedWriter out = new BufferedWriter(new FileWriter(StLogFileName1, true));
